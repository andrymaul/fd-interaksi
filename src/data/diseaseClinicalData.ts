/**
 * BASIS DATA RESMI INTERAKSI OBAT-PENYAKIT (DDSI)
 * 
 * 100% SUMBER RESMI: DDInter v2.0 (https://ddinter2.scbdd.com/)
 * College of Pharmaceutical Sciences, Zhejiang University &
 * Xiangya School of Pharmaceutical Sciences, Central South University.
 * 
 * Seluruh data eksternal di luar portal DDInter v2.0 telah dihapus sepenuhnya.
 */

import { DiseaseClinicalMonograph } from '../types/pharmacy.ts';

export const DDINTER_OFFICIAL_URL = 'https://ddinter2.scbdd.com/';
export const DDINTER_DISEASE_PORTAL_URL = 'https://ddinter2.scbdd.com/server/dis_food/';
...
export const DISEASE_REGISTRY: Record<string, DiseaseKnowledgeItem> = {
  "liver diseases": {
    name: "Liver Diseases",
  ...
  "guillain-barre syndrome": {
    ...
    ddinterOfficialUrl: "https://ddinter2.scbdd.com/server/dis_food/",
    ddinterWarningSummary: "Persons previously diagnosed with Guillain-Barré syndrome (GBS) may be at increased risk of GBS following receipt of meningococcal conjugate vaccine.  The decision to give this vaccine should take into account the potential benefits and risks.",
    ddinterSeverityDistribution: {
      major: 0,
      moderate: 1,
      minor: 0,
...
export function getDiseaseClinicalMonograph(diseaseName: string): DiseaseClinicalMonograph {
  ...
  // Dynamic fallback for any disease name strictly referencing DDInter v2.0
  return {
